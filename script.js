...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const revealElements = document.querySelectorAll(
    '.section-title, .section-subtitle, .service-card, .process-step, .comparison-table, .comparison-cta-button, .comparison-cta, .testimonial-card, .pricing-card, .pricing-note, .contact-form'
  );
